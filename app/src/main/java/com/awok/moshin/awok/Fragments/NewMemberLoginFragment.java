...
public class NewMemberLoginFragment extends Fragment {

    View mView;
    EditText emailEditText;
    Button continueButton;
    private String TAG = "New Member Login Fragment";
    public NewMemberLoginFragment(){}
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mView = inflater.inflate(R.layout.fragment_new_member_login, container, false);
        emailEditText = (EditText) mView.findViewById(R.id.emailEditText);
        continueButton = (Button) mView.findViewById(R.id.continueButton);
