 ...
 */
public class ProductRecommendedRelatedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {


    private List<ProductRecommendedRelatedModel> moviesList;
    Context mContext;
...
//            nameTextView = (TextView)itemView.findViewById(R.id.nameTextView);
    ...
    public ProductRecommendedRelatedAdapter(Activity activity, List<ProductRecommendedRelatedModel> moviesList) {
 ...
 /*       View itemView = LayoutInflater.from(parent.getContext())
    ...
    public void onBindViewHolder(final RecyclerView.ViewHolder holder1, int position) {
        ...
        if (holder1.getItemViewType() == 2) {
            ...
            ProductRecommendedRelatedModel movie = moviesList.get(position);
