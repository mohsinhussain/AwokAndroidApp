 ...
 */
public class InterestLanguageAdapter extends BaseAdapter {
    private Activity activity;
    private LayoutInflater inflater;
    Context context;
    private List<Interest_LanguageModel> movieItems;
    ImageLoader imageLoader = AppController.getInstance().getImageLoader();
    Map<Integer,String> list = new HashMap<Integer,String>();
    public InterestLanguageAdapter(Activity activity, List<Interest_LanguageModel> movieItems,Context context) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        Interest_LanguageModel m = movieItems.get(position);
