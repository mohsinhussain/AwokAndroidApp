 ...
 */
    ...
    public class ProductRatingPageAdapter extends RecyclerView.Adapter<ProductRatingPageAdapter.ViewHolder> {
        ...
        @Override
        public ProductRatingPageAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
            // create a new view
