...
public class SignInFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        userNameEditText = (EditText) mView.findViewById(R.id.usernameEditText);
        passwordEditText = (EditText) mView.findViewById(R.id.passwordEditText);
        signInButton = (Button) mView.findViewById(R.id.continueButton);
