...
/**
 * Created by shon on 10/25/2015.
 */

    public class StoreRatingAdapter extends RecyclerView.Adapter<StoreRatingAdapter.ViewHolder> {
        private List<StoreRatingModel> OverViewList = new ArrayList<StoreRatingModel>();
        private Activity activity;



        // Provide a suitable constructor (depends on the kind of dataset)
        public StoreRatingAdapter(Activity activity,List<StoreRatingModel> overViewList) {
        ...
        @Override
        public StoreRatingAdapter.ViewHolder onCreateViewHolder(ViewGroup parent,
                                                                  int viewType) {
            // create a new view
